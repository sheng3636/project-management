  ...
  <div class="app-container">
    ...
    <div class="main-wrapper">
      ...
      <el-table :data="tableList" border fit highlight-current-row>
        ...
        <el-table-column prop="create_time" align="center" width="150" label="创建时间" />
          ...
          <template slot-scope="scope">
            <div class="columnOptionBtn">
              <el-button plain type="text" size="mini">
                <router-link :to="`/project/projectDashboard/${scope.row.project_id}`">进 入</router-link></el-button>
            </div>
          </template>
        </el-table-column>
      </el-table>
      <!--分页-->
      <el-pagination :page-sizes="[10, 20, 30, 40]" layout="total, sizes, prev, pager, next, jumper" :total="total"
        @size-change="handleSizeChange" @current-change="handleCurrentChange" />
    </div>
    <add-project :add-edit-visi="addEditVisi" :add-edit-form="addEditForm" :dialog-title="addEditTitle"
